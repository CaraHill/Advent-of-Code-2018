...
function numberOfTwoFers() {
  inputs.forEach(sequence => {
    ...
    if (Object.values(results).includes(2)) {
      twoFerCount += 1;
    }
...
function numberOfThreeFers() {
  inputs.forEach(sequence => {
    ...
    if (Object.values(results).includes(3)) {
      threeFerCount += 1;
    }

  });

  return threeFerCount;
}

function multiply() {
  return numberOfTwoFers() * numberOfThreeFers();
}
